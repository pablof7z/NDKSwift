...
- **Entitlements File**: `Config/OlasApp.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/OlasApp.entitlements`:
