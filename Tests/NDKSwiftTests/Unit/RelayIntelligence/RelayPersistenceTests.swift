...
final class RelayPersistenceTests: XCTestCase {
    ...
    func test_pool_explicitRelays_arePersistent() async throws {
    ...
    func test_pool_discoveryRelays_areNotPersistent() async throws {
        let ndk = try await NDKTestFactory.createNDK()
    ...
    func test_pool_outboxConfigRelays_arePersistent() async throws {
        let ndk = try await NDKTestFactory.createNDK()
