...
actor TestableCache: NDKCache {
    ...
    func processEvent(_ event: NDKEvent, from _: String, subscriptionId _: String) async throws {
    ...
    func observeEvents(matching _: NDKFilter, includeExisting _: Bool) async -> AsyncThrowingStream<[NDKEvent], Error> {
