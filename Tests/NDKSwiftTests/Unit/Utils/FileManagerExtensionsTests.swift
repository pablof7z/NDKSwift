...
final class FileManagerExtensionsTests: XCTestCase {
    ...
    func testSaveAndLoadCodable() throws {
        let testModel = TestModel(id: 1, name: "Test", timestamp: 1_234_567_890)
    ...
    func testLoadAllCodable() throws {
        // Create test models
        let models = [
            TestModel(id: 1, name: "Model 1", timestamp: 1_234_567_890),
            TestModel(id: 2, name: "Model 2", timestamp: 1_234_567_891),
            TestModel(id: 3, name: "Model 3", timestamp: 1_234_567_892),
        ]
    ...
    func testLoadAllCodableWithFilenames() throws {
        // Create test models
        let models = [
            ("user1", TestModel(id: 1, name: "User 1", timestamp: 1_234_567_890)),
            ("user2", TestModel(id: 2, name: "User 2", timestamp: 1_234_567_891)),
            ("settings", TestModel(id: 3, name: "Settings", timestamp: 1_234_567_892)),
        ]
    ...
    func testLoadAllCodableWithFilenames_CustomExtension() throws {
        let model = TestModel(id: 1, name: "Custom", timestamp: 1_234_567_890)
    ...
    func testLoadAllCodableWithFilenames_SkipsInvalidFiles() throws {
        let validModel = TestModel(id: 1, name: "Valid", timestamp: 1_234_567_890)
