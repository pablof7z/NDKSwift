...
final class EventDeletionE2ETests: XCTestCase {
    ...
    func testCrossInstanceDeletionSyncE2E() async throws {
        ...
        let expectation2 = expectation(description: "Instance 2 receives deletion")
        let expectation3 = expectation(description: "Instance 3 receives deletion")
        ...
        // Monitor for deletion propagation
        Task {
            ...
            if deletedOnInstance2 { expectation2.fulfill() }
            if deletedOnInstance3 { expectation3.fulfill() }
        }
        
        await fulfillment(of: [expectation2, expectation3], timeout: 10.0)
