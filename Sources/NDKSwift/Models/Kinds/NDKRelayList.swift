...
extension NDK {
    ...
    public func fetchRelayList(for user: NDKUser) async throws -> NDKRelayList? {
    ...
    public func fetchRelayList() async throws -> NDKRelayList? {
    ...
    public func publishRelayList(_ relayList: NDKRelayList) async throws {
