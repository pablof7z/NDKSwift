...
/// Handles payment operations for Cashu wallets
/// This includes Lightning payments, cross-mint transfers, and direct Cashu token transfers
public actor PaymentProcessor {
    ...
    private func totalAmount(of proofs: [CashuSwift.Proof]) -> UInt64 {
        return proofs.reduce(0) { $0 + UInt64($1.amount) }
    }
}

// MARK: - Supporting Types

/// Internal result type for payment processor
