...
/// SQLite-backed cache implementation with proper migrations
public actor NDKSQLiteCacheMigrated: NDKCache, MintCache {
    ...
    public init(path: String? = nil, debugMode: Bool = false) async throws {
        ...
        if let customPath = path {
            ...
            self.dbPath = documentsPath.appendingPathComponent("ndk_cache_v2.db").path
        }
