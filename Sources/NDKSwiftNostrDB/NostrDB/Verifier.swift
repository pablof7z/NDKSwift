...
public struct Verifier {
    ...
    private let _checkAlignment: Bool
    /// Capacity of the current buffer
    private var _capacity: Int
    /// Current ApparentSize
    private var _apparentSize: UOffset = 0
    /// Amount of tables present within a buffer
    private var _tableCount = 0
    ...
    public mutating func isAligned<T>(position: Int, type _: T.Type) throws {
    ...
    mutating func getValue<T>(at position: Int) throws -> T {
    ...
    @inline(__always)
    mutating func derefOffset(position: Int) throws -> Int {
