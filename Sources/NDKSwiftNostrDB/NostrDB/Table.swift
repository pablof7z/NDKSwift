...
public struct Table {
    ...
    public func readBuffer<T>(of _: T.Type, at o: Int32) -> T {
    ...
    ///   - type: Type of Element that needs to be read from the buffer
    ///   - o: Offset of the Element
    public func directRead<T>(of _: T.Type, offset o: Int32) -> T {
    ...
    public func directUnion<T: FlatbuffersInitializable>(_ o: Int32) -> T {
        T(bb, o: o + bb.read(def: Int32.self, position: Int(o)))
    }
    ...
    public static func indirect(_ o: Int32, _ fbb: ByteBuffer) -> Int32 {
